...
{/* YTD / Monthly toggle */}
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center justify-center gap-2 flex-shrink-0 self-stretch px-3">
            ...
            <div className="flex flex-col gap-2 p-3 bg-[#e6e6e6] rounded-xl items-center justify-center self-stretch w-[3vw]">
              <button onClick={() => setViewMode("ytd")}
                className={`px-3 py-1.5 rounded-lg text-[10px] font-black transition-all ${viewMode === "ytd" ? "bg-white text-[#1a2f8a] shadow-sm" : "text-[#636363]"}`}>
                YTD
              </button>
...
<div className="ml-auto flex items-center gap-3 flex-shrink-0 mr-6">
          ...
          <button onClick={() => setCompareMode(c => !c)}
            className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-black transition-all
              ${compareMode ? "bg-amber-400 text-[#1a2f8a]" : "bg-white border border-gray-200 text-gray-500 hover:text-[#1a2f8a] shadow-sm"}`}>
